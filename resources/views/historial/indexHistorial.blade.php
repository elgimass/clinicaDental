...
<table class="table table-borderless table-hover">
    ...
    <tbody>
        @foreach ( $historiales as $historial )
            <tr>
                @if ($historial -> paciente_id == $pacientes -> id)
                <th>{{$historial->id}}</th>
            ...
            <th>
                ...
                Editar
                    ...
                    @else
                        ...
                        @foreach ($tratamientos as $tratamiento)
                            @if ($historial->tratamiento_id == $tratamiento->id)
                                <th hidden>{{$tratamiento->nombre}}</th>
                            @endif
                        @endforeach



                        <th hidden>{{$historial->pieza}}</th>




                        <th hidden>{{$historial->fecha}}</th>
                        <th hidden>{{$historial->estado}}</th>
                        <th hidden>{{$historial->observaciones}}</th>
